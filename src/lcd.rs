...
use rp_pico::hal::{gpio, I2C, Timer};
...
impl<DP: PinId + BankPinId, CP: PinId + BankPinId> RainbowAnimation for lcd_1602_i2c::Lcd<I2C<I2C0, (Pin<DP, Function<gpio::I2C>>, Pin<CP, Function<gpio::I2C>>)>>{
